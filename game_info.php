...
?>
<a href="games.php?" class="flex items-center text-indigo-700 border border-indigo-600 py-2 px-6 gap-2 rounded inline-flex items-center">
    ...
    <div class="container mx-auto px-4 py-8">
        <div class="flex flex-wrap -mx-4">
            ...
            <div class="w-full md:w-1/2 px-4 mb-8">
                <img src="assets/images/assassingsSmall.jpg" alt="Product" class="w-full h-auto rounded-lg shadow-md mb-4" id="mainImage">
          ...
          <img src="https://images.unsplash.com/photo-1528148343865-51218c4a13e6?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NzEyNjZ8MHwxfHNlYXJjaHwzfHxoZWFkcGhvbmV8ZW58MHwwfHx8MTcyMTMwMzY5MHww&ixlib=rb-4.0.3&q=80&w=1080" alt="Thumbnail 4"
            ...
            <div class="w-full md:w-1/2 px-4">
                <h2 class="text-3xl font-bold mb-2"> <?= htmlspecialchars($game['game_name'], ENT_QUOTES, 'UTF-8') ?></h2>
                <p class="text-gray-600 mb-4"> <?= htmlspecialchars($game['genre_name'], ENT_QUOTES, 'UTF-8') ?></p>
                <div class="mb-4">
                    <span class="text-2xl font-bold mr-2"> <?= htmlspecialchars($game['game_price'], ENT_QUOTES, 'UTF-8') ?></span>
                    <span class="text-gray-500 line-through"><?= htmlspecialchars($game['game_price'] + $game['game_price'] * 0.20, ENT_QUOTES, 'UTF-8') ?></span>
                </div>
                <div class="flex items-center mb-4">
                    ...
                    <span class="ml-2 text-gray-600"><?= htmlspecialchars($game['game_rating'], ENT_QUOTES, 'UTF-8') ?></span>
                </div>
                <p class="text-gray-700 mb-6"><?= htmlspecialchars($game['game_description'], ENT_QUOTES, 'UTF-8') ?></p>
